...
describe("Testing", () => {
    test("chessBoardStartingSetup", () => {
      ...
      for(let i=0;i<8;++i) {
        ...
        obj2.push({ location: {row: 1, col: column}, pieceType: colToPiece.get(column), isplayerPiece: true, isInGame: true, hasMoved: false });
        obj2.push({ location: {row: 2, col: column}, pieceType: "pawn", isplayerPiece: true, isInGame: true, hasMoved: false  });
        obj2.push({ location: {row: 7, col: column}, pieceType: "pawn", isplayerPiece: false, isInGame: true, hasMoved: false  });
        obj2.push({ location: {row: 8, col: column}, pieceType: colToPiece.get(column), isplayerPiece: false, isInGame: true, hasMoved: false  });
      }
    ...
    test("isValidMovePawn2Forward true", () => {
      let setup = [
        ...
        { location: {row: 5, col: 'd'}, pieceType: "pawn", isplayerPiece: false, isInGame: true, hasMoved: true }
      ];

      expect(functions.isValidMovePawn2Forward(setup,1,{row: 4,col: 'd'})).toBe(true);
    });
    ...
    test("isValidMovePawn2Forward false - other piece at location", () => {
      let setup = [
        { location: {row: 2, col: 'c'}, pieceType: "pawn", isplayerPiece: true, isInGame: true, hasMoved: false },
        { location: {row: 2, col: 'd'}, pieceType: "pawn", isplayerPiece: true, isInGame: true, hasMoved: false },
        { location: {row: 4, col: 'd'}, pieceType: "pawn", isplayerPiece: false, isInGame: true, hasMoved: true }
      ];

      expect(functions.isValidMovePawn2Forward(setup,1,{row: 4,col: 'd'})).toBe(false);
    });
    ...
    test("isValidMovePawn2Forward false - other piece in front of location", () => {
      ...
      expect(functions.isValidMovePawn2Forward(setup,1,{row: 3,col: 'd'})).toBe(false);
    });

    test("isValidMovePawn2Forward false - invalid location", () => {
      let setup = [
        { location: {row: 2, col: 'c'}, pieceType: "pawn", isplayerPiece: true, isInGame: true, hasMoved: false },
        { location: {row: 2, col: 'd'}, pieceType: "pawn", isplayerPiece: true, isInGame: true, hasMoved: false },
        { location: {row: 5, col: 'd'}, pieceType: "pawn", isplayerPiece: false, isInGame: true, hasMoved: true }
      ...
      expect(functions.isValidMovePawn2Forward(setup,1,{row: 7,col: 'g'})).toBe(false);
    });
});